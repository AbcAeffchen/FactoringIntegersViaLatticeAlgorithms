...
//        abs(this->right_side,this->left_side - this->vN * this->k_n - sign * this->h_n * this->N);
        ...
        if(this->isSmooth(this->equation, this->k_n, this->left_side, this->right_side))
        {
            ...
            this->equations.emplace_back(this->equation, this->ride_side_factor, this->current_level, conv<double>(temp_RR), this->round, this->threadId, this->timer.step(),cf_equation);
        }
